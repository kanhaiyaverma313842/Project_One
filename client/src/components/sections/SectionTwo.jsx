...
const SectionTwo = () => {
  return (
    <div className='flex flex-col lg:flex-row items-center justify-between h-full  lg:h-[626px] gap-[30px] lg:gap-[60px]'>
      ...
      <div className='w-full lg:w-3/5 flex flex-col md:flex-row  gap-[50px] h-min'>
      ...
      <div className='w-full lg:w-3/5 flex flex-col md:flex-row  gap-[50px] h-[460px]'>
      <div className='rounded-[25px] bg-[#E7F4C0]'>
      ...
      <div className='p-6  flex flex-col items-start justify-center space-y-6'>
      <div className='space-y-4'>
        <h3 className='text-neutral-black text-lg font-semibold leading-normal capitalize'>A Journey of Hope and Support</h3>
