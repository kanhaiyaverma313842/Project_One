...
<div className="flex flex-col md:flex-row justify-between items-center rounded-[25px] bg-neutral-pink p-0 gap-10 md:gap-[100px]">
  ...
  <div className="w-full md:w-1/2 flex justify-center md:justify-start">
    <img 
      src={imgOneSecOne} 
      alt="img1" 
      className="w-full max-w-[500px] md:max-w-[634px] h-auto md:h-[448px] "
    />
  </div>

  {/* Text and Button Section */}
  <div className="w-full md:w-1/2 flex flex-col gap-10 text-center md:text-left  md:pr-[45px] pr-0  md:px:0 px-[15px] md:pb-0 pb-[15px] ">
    <div className="flex flex-col gap-5  ">
      <h2 className="text-neutral-black font-opensans text-[24px] sm:text-[28px] md:text-[34px] font-semibold leading-[32px] sm:leading-[38px] md:leading-[44px] capitalize">
        Helping Blind &amp; Leprosy Patients
      </h2>
      <p className="font-montserrat text-neutral-black text-base sm:text-lg md:text-xl font-normal leading-[24px] sm:leading-[26px] md:leading-[28px]  ">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam
      </p>
    </div>

    <button className="self-center md:self-start flex justify-center items-center w-[135px] h-[44px] px-[5px] py-[10px] rounded-[50px] bg-[#F78C00]">
  ...
  <div className="space-y-10 p-4  w-full flex-row md:flex-col  ">
    {/* Row 1 */}
    {
      ...
      (
    <div className="flex flex-col lg:flex-row gap-10" key={index}>
